...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
        ...
        files: [
          {
            ...
            cwd: "dist/",
            src: ["**"],
            dest: npmPackage.name + "/" + npmPackage.version + "/",
          },
        ],
      },
    },
    ...
    postcss: {
      ...
      dev: {
        files: {
          "<%= projectConfig.dist %>/main.css":
            "<%= projectConfig.temp %>/main.css",
        },
      },
      dist: {
        files: {
  ...
  // Register tasks
  grunt.registerTask("dev", ["clean:temp", "clean:dist", "concat:dev"]);
